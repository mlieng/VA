...
run_settings_GUI(*){
	...
	g.Add("Text","xm w150", "`n")
	;str_res := "Current Name: " choice_resident
	g.Add("Text","xm w150", "Current Name: ")
	text_res := g.Add("Text","yp w250", choice_resident)

	; name
	g.Add("Text","xm w150", "Your name:")
	...
	g.Add("Text","xm w150", "Attending Name:") ;xp starts a new row, same location as previous. xm starts new row below all aspects
	CtlAtt := g.Add("ComboBox","vCB2 yp w200 h100 r5 Section",AttendingList) ; yp next col
	CtlAtt.AutoComplete := true

	; attending Last, First
	g.Add("Text","xm w150", "`n")
	g.Add("Text","xm w150", "Current Last Name: ")
	text_att_rev := g.Add("Text","yp w250", choice_attending_reverse)

	g.Add("Text","xm w150", "Attending Last Name:") ;xp starts a new row, same location as previous. xm starts new row below all aspects
	...
	;nurse name
	g.Add("Text","xm w150", "`n")
	g.Add("Text","xm w150", "Current Nurse Name: ")
	text_nurse := g.Add("Text","yp w250", choice_nurse)

	g.Add("Text","xm w150", "Nurse Name:") ;xp starts a new row, same location as previous. xm starts new row below all aspects
	CtlNurse := g.Add("ComboBox","vCB4 yp w200 h100 r5 Section", NurseList) ; yp next col
	CtlNurse.AutoComplete := true

	;pass key name
	g.Add("Text","xm w150", "`n")
	g.Add("Text","xm w150", "6-Digit Keypass: ")
	text_saved_6digit := g.Add("Text","yp w250", choice_saved_6digit)

	g.Add("Text","xm w150", "6-Digit Keypass:") ;xp starts a new row, same location as previous. xm starts new row below all aspects
	CtlKeypass := g.Add("Edit","vSaved6digit yp r1") ; yp next col
	...
	gui_close(*) {
		...
		if not (CtlKeypass.Text = ""){
			choice_saved_6digit    := Saved_Settings.Saved6digit
			text_saved_6digit.Text := choice_saved_6digit
		}

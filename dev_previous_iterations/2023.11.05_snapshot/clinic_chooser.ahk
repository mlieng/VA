...
clinic_chooser()
{
	...
	CtlRes := clinicGUI.Add("ComboBox","vCB yp w300 h100 r5 Section",ClinicList)
	; CtlRes := clinicGUI.Add("ComboBox","vCB +10 yp w200 h100 r5 Section",ClinicList)
